...
//        studentsAdapter = new StudentsAdapter(studentsList, this, this, true); // isAdmin = true for admin
...
//                .setSmallIcon(R.drawable.logo) // Add a logo drawable in res/drawable
